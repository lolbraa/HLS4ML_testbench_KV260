set SynModuleInfo {
  ...
  {SRCNAME load_input<float,array<ap_fixed,16u>>_Pipeline_VITIS_LOOP_13_1 MODELNAME load_input_float_array_ap_fixed_16u_Pipeline_VITIS_LOOP_13_1 RTLNAME myproject_axi_master_load_input_float_array_ap_fixed_16u_Pipeline_VITIS_LOOP_13_1
    SUBMODULES {
  ...
  {SRCNAME dense_latency_wrapper<ap_fixed,ap_fixed<16,6,5,3,0>,config4> MODELNAME dense_latency_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config4_s RTLNAME myproject_axi_master_dense_latency_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config4_s}
  ...
  {SRCNAME myproject MODELNAME myproject RTLNAME myproject_axi_master_myproject
    SUBMODULES {
      {MODELNAME myproject_axi_master_fifo_w1024_d1_S RTLNAME myproject_axi_master_fifo_w1024_d1_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME layer2_out_i_U}
      {MODELNAME myproject_axi_master_fifo_w1024_d1_S RTLNAME myproject_axi_master_fifo_w1024_d1_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME layer3_out_i_U}
      {MODELNAME myproject_axi_master_fifo_w80_d1_S RTLNAME myproject_axi_master_fifo_w80_d1_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME layer4_out_i_U}
  ...
  {SRCNAME myproject_axi_master MODELNAME myproject_axi_master RTLNAME myproject_axi_master IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME myproject_axi_master_fifo_w32_d2_S RTLNAME myproject_axi_master_fifo_w32_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME batch_size_c9_U}
