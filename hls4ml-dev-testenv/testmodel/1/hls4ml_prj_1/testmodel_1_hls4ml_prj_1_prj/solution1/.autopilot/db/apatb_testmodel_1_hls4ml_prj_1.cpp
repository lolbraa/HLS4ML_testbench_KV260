...
// wrapc file define:
#define AUTOTB_TVIN_fc1_input "../tv/cdatafile/c.testmodel_1_hls4ml_prj_1.autotvin_fc1_input.dat"
#define WRAPC_STREAM_SIZE_IN_fc1_input "../tv/stream_size/stream_size_in_fc1_input.dat"
#define WRAPC_STREAM_INGRESS_STATUS_fc1_input "../tv/stream_size/stream_ingress_status_fc1_input.dat"
#define AUTOTB_TVOUT_layer13_out "../tv/cdatafile/c.testmodel_1_hls4ml_prj_1.autotvout_layer13_out.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_layer13_out "../tv/rtldatafile/rtl.testmodel_1_hls4ml_prj_1.autotvout_layer13_out.dat"
...
extern "C"
void testmodel_1_hls4ml_prj_1_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_testmodel_1_hls4ml_prj_1_hw(void* __xlx_apatb_param_fc1_input, void* __xlx_apatb_param_layer13_out)
{
  static hls::sim::Stream<hls::sim::Byte<32>> port0 {
    .width = 256,
    .name = "fc1_input",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_fc1_input),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_fc1_input),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_fc1_input),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_fc1_input),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<32>>*)__xlx_apatb_param_fc1_input;
  ...
  port1.param = (hls::stream<hls::sim::Byte<10>>*)__xlx_apatb_param_layer13_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    testmodel_1_hls4ml_prj_1_hw_stub_wrapper(__xlx_apatb_param_fc1_input, __xlx_apatb_param_layer13_out);
    port1.buffer();
