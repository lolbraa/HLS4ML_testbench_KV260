...
#define AUTOTB_TVOUT_gmem_in0_ptr_linput "../tv/cdatafile/c.myproject_axi_master.autotvout_gmem_in0_ptr_linput.dat"
...
extern "C"
void apatb_myproject_axi_master_hw(void* __xlx_apatb_param_gmem_in0_ptr_linput, void* __xlx_apatb_param_gmem_out0_ptr_layer9_out, hls::sim::Byte<4> __xlx_apatb_param_batch_size)
{
  static hls::sim::Byte<4> __xlx_offset_byte_param_gmem_in0_ptr_linput;
  static hls::sim::Register port0 {
    .name = "gmem_in0_ptr_linput",
    .width = 32,
#ifdef POST_CHECK
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_gmem_in0_ptr_linput),
#endif
  };
  port0.param = &__xlx_offset_byte_param_gmem_in0_ptr_linput;
  ...
  port3.param = { __xlx_apatb_param_gmem_in0_ptr_linput };
  port3.mname = { "gmem_in0_ptr_linput" };
  port3.nbytes = { 64 };
  ...
  try {
    ...
    myproject_axi_master_hw_stub_wrapper(__xlx_apatb_param_gmem_in0_ptr_linput, __xlx_apatb_param_gmem_out0_ptr_layer9_out, __xlx_apatb_param_batch_size);
