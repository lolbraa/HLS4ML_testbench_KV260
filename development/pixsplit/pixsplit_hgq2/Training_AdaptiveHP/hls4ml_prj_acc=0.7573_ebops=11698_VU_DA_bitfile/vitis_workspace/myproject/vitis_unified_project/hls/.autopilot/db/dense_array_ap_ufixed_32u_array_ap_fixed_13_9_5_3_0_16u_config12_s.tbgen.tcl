set moduleName dense_array_ap_ufixed_32u_array_ap_fixed_13_9_5_3_0_16u_config12_s
set isTopModule 0
...
set cdfgNum 24
set C_modelName {dense<array<ap_ufixed,32u>,array<ap_fixed<13,9,5,3,0>,16u>,config12>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer10_out int 256 regular {fifo 0 volatile }  }
	{ layer12_out int 208 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer10_out", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY"} , 
 	{ "Name" : "layer12_out", "interface" : "fifo", "bitwidth" : 208, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer12_out_din sc_out sc_lv 208 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer12_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":208, "type": "signal", "bundle":{"name": "layer12_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	layer12_out { ap_fifo {  { layer12_out_din fifo_data_out 1 208 }  { layer12_out_full_n fifo_status_empty 0 1 }  { layer12_out_write fifo_data_in 1 1 }  { layer12_out_num_data_valid fifo_update 0 2 }  { layer12_out_fifo_cap fifo_data 0 2 } } }
}
