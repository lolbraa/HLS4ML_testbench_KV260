...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_axi_master_start_for_store_result_float_array_ap_fixed_14_8_5_3_0_3u_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_store_result_float_array_ap_fixed_14_8_5_3_0_3u_U0_U}
}
