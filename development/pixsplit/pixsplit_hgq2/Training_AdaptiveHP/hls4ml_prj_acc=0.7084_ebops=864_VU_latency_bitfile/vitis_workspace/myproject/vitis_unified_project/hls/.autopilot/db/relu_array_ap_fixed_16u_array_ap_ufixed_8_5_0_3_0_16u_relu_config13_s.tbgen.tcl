...
set C_modelArgList {
	{ layer12_out int 176 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer12_out", "interface" : "fifo", "bitwidth" : 176, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer12_out_dout sc_in sc_lv 176 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer12_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":176, "type": "signal", "bundle":{"name": "layer12_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer12_out { ap_fifo {  { layer12_out_dout fifo_data_out 0 176 }  { layer12_out_empty_n fifo_status_empty 0 1 }  { layer12_out_read fifo_data_in 1 1 }  { layer12_out_num_data_valid fifo_update 0 2 }  { layer12_out_fifo_cap fifo_data 0 2 } } }
