...
struct config3 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 7551;
    static const unsigned n_nonzeros = 129;
...
struct config6 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 8104;
...
struct config9 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 2019;
...
struct config12 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 501;
