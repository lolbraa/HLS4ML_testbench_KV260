...
HD_PWD='/work/development/pixsplit/pixsplit_hgq2/Training_AdaptiveHP/hls4ml_prj_acc=0.7573_ebops=11698_VU_latency_bitfile/vitis_workspace/system_link/_x/link/vivado/vpl'
cd "$HD_PWD"
