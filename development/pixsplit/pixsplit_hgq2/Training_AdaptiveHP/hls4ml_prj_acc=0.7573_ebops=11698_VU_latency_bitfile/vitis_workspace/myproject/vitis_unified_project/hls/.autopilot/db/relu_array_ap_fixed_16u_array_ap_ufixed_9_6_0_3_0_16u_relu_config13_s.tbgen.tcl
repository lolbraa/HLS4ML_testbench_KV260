set moduleName relu_array_ap_fixed_16u_array_ap_ufixed_9_6_0_3_0_16u_relu_config13_s
set isTopModule 0
...
set cdfgNum 24
set C_modelName {relu<array<ap_fixed,16u>,array<ap_ufixed<9,6,0,3,0>,16u>,relu_config13>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer12_out int 208 regular {fifo 0 volatile }  }
	{ layer13_out int 144 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer12_out", "interface" : "fifo", "bitwidth" : 208, "direction" : "READONLY"} , 
 	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 144, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer13_out_din sc_out sc_lv 144 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":144, "type": "signal", "bundle":{"name": "layer13_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	layer13_out { ap_fifo {  { layer13_out_din fifo_data_out 1 144 }  { layer13_out_full_n fifo_status_empty 0 1 }  { layer13_out_write fifo_data_in 1 1 }  { layer13_out_num_data_valid fifo_update 0 2 }  { layer13_out_fifo_cap fifo_data 0 2 } } }
}
