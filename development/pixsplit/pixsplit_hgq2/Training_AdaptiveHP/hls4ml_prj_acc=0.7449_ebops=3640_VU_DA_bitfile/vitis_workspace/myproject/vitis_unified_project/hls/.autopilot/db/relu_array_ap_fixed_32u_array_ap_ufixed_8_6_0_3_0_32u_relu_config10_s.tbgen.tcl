...
set C_modelArgList {
	{ layer9_out int 480 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer9_out", "interface" : "fifo", "bitwidth" : 480, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer9_out_dout sc_in sc_lv 480 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer9_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":480, "type": "signal", "bundle":{"name": "layer9_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer9_out { ap_fifo {  { layer9_out_dout fifo_data_out 0 480 }  { layer9_out_empty_n fifo_status_empty 0 1 }  { layer9_out_read fifo_data_in 1 1 }  { layer9_out_num_data_valid fifo_update 0 2 }  { layer9_out_fifo_cap fifo_data 0 2 } } }
