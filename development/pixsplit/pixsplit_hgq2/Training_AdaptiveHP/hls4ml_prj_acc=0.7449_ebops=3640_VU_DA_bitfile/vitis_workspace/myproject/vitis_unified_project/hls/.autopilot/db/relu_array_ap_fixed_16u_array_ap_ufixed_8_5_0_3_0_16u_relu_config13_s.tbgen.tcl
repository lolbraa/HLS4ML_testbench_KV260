set moduleName relu_array_ap_fixed_16u_array_ap_ufixed_8_5_0_3_0_16u_relu_config13_s
set isTopModule 0
...
set cdfgNum 24
set C_modelName {relu<array<ap_fixed,16u>,array<ap_ufixed<8,5,0,3,0>,16u>,relu_config13>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer12_out int 208 regular {fifo 0 volatile }  }
	{ layer13_out int 128 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer12_out", "interface" : "fifo", "bitwidth" : 208, "direction" : "READONLY"} , 
 	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer12_out_dout sc_in sc_lv 208 signal 0 } 
	...
	{ layer13_out_din sc_out sc_lv 128 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer12_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":208, "type": "signal", "bundle":{"name": "layer12_out", "role": "dout" }} , 
 	...
 	{ "name": "layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer13_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer12_out { ap_fifo {  { layer12_out_dout fifo_data_out 0 208 }  { layer12_out_empty_n fifo_status_empty 0 1 }  { layer12_out_read fifo_data_in 1 1 }  { layer12_out_num_data_valid fifo_update 0 2 }  { layer12_out_fifo_cap fifo_data 0 2 } } }
	layer13_out { ap_fifo {  { layer13_out_din fifo_data_out 1 128 }  { layer13_out_full_n fifo_status_empty 0 1 }  { layer13_out_write fifo_data_in 1 1 }  { layer13_out_num_data_valid fifo_update 0 2 }  { layer13_out_fifo_cap fifo_data 0 2 } } }
}
