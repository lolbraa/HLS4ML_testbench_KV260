...
HD_PWD='/work/development/pixsplit/pixsplit_hgq2/Training_AdaptiveHP/hls4ml_prj_acc=0.7449_ebops=3640_VU_DA_bitfile/vitis_workspace/system_link/_x/link/vivado/vpl'
cd "$HD_PWD"
