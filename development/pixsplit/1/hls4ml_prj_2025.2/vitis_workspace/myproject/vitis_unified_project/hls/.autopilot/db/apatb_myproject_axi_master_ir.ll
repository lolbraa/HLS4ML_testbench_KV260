; ModuleID = '/home/ncgadmin/Bachelor/HLS4ML_testbench_KV260/development/pixsplit/1/hls4ml_prj_2025.2/vitis_workspace/myproject/vitis_unified_project/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline willreturn
define void @apatb_myproject_axi_master_ir(float* noalias nocapture nonnull readonly "maxi" %gmem_in0_ptr_input_layer_18, float* noalias nocapture nonnull "maxi" %gmem_out0_ptr_layer15_out, i32 %batch_size) local_unnamed_addr #0 {
entry:
  %0 = bitcast float* %gmem_in0_ptr_input_layer_18 to [60 x float]*
  %gmem_in0_ptr_input_layer_18_copy = alloca [60 x float], align 512
  %1 = bitcast float* %gmem_out0_ptr_layer15_out to [3 x float]*
  %gmem_out0_ptr_layer15_out_copy = alloca [3 x float], align 512
  call fastcc void @copy_in([60 x float]* nonnull %0, [60 x float]* nonnull align 512 %gmem_in0_ptr_input_layer_18_copy, [3 x float]* nonnull %1, [3 x float]* nonnull align 512 %gmem_out0_ptr_layer15_out_copy)
  call void @apatb_myproject_axi_master_hw([60 x float]* %gmem_in0_ptr_input_layer_18_copy, [3 x float]* %gmem_out0_ptr_layer15_out_copy, i32 %batch_size)
  call void @copy_back([60 x float]* %0, [60 x float]* %gmem_in0_ptr_input_layer_18_copy, [3 x float]* %1, [3 x float]* %gmem_out0_ptr_layer15_out_copy)
  ret void
}
