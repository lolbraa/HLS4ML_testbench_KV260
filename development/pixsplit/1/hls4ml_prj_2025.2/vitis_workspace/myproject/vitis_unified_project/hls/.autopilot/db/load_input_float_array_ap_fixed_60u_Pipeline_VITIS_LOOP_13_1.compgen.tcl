...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_axi_master_sparsemux_9_3_15_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_in0_input_layer_18_din { O 960 vector } stream_in0_input_layer_18_full_n { I 1 bit } stream_in0_input_layer_18_write { O 1 bit } stream_in0_input_layer_18_num_data_valid { I 8 vector } stream_in0_input_layer_18_fifo_cap { I 8 vector } } \
} "
}
