set moduleName dense_array_ap_fixed_16u_array_ap_fixed_20_11_5_3_0_3u_config15_s
set isTopModule 0
...
set cdfgNum 22
set C_modelName {dense<array<ap_fixed,16u>,array<ap_fixed<20,11,5,3,0>,3u>,config15>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer13_out int 192 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 192, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer13_out_dout sc_in sc_lv 192 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer13_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":192, "type": "signal", "bundle":{"name": "layer13_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer13_out { ap_fifo {  { layer13_out_dout fifo_data_out 0 192 }  { layer13_out_empty_n fifo_status_empty 0 1 }  { layer13_out_read fifo_data_in 1 1 }  { layer13_out_num_data_valid fifo_update 0 2 }  { layer13_out_fifo_cap fifo_data 0 2 } } }
