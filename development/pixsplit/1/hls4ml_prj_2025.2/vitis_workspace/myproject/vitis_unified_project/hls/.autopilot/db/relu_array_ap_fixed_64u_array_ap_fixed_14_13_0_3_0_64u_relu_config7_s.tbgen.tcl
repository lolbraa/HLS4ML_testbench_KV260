set moduleName relu_array_ap_fixed_64u_array_ap_fixed_14_13_0_3_0_64u_relu_config7_s
set isTopModule 0
...
set cdfgNum 22
set C_modelName {relu<array<ap_fixed,64u>,array<ap_fixed<14,13,0,3,0>,64u>,relu_config7>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer6_out int 1344 regular {fifo 0 volatile }  }
	{ layer7_out int 896 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 1344, "direction" : "READONLY"} , 
 	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 896, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer6_out_dout sc_in sc_lv 1344 signal 0 } 
	...
	{ layer7_out_din sc_out sc_lv 896 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer6_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1344, "type": "signal", "bundle":{"name": "layer6_out", "role": "dout" }} , 
 	...
 	{ "name": "layer7_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":896, "type": "signal", "bundle":{"name": "layer7_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_out 0 1344 }  { layer6_out_empty_n fifo_status_empty 0 1 }  { layer6_out_read fifo_data_in 1 1 }  { layer6_out_num_data_valid fifo_update 0 2 }  { layer6_out_fifo_cap fifo_data 0 2 } } }
	layer7_out { ap_fifo {  { layer7_out_din fifo_data_out 1 896 }  { layer7_out_full_n fifo_status_empty 0 1 }  { layer7_out_write fifo_data_in 1 1 }  { layer7_out_num_data_valid fifo_update 0 2 }  { layer7_out_fifo_cap fifo_data 0 2 } } }
}
