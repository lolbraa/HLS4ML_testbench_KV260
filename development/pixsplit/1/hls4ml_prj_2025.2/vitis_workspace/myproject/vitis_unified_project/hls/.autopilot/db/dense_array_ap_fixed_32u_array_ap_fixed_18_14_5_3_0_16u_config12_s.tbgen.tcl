set moduleName dense_array_ap_fixed_32u_array_ap_fixed_18_14_5_3_0_16u_config12_s
set isTopModule 0
...
set cdfgNum 22
set C_modelName {dense<array<ap_fixed,32u>,array<ap_fixed<18,14,5,3,0>,16u>,config12>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer10_out int 416 regular {fifo 0 volatile }  }
	{ layer12_out int 288 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer10_out", "interface" : "fifo", "bitwidth" : 416, "direction" : "READONLY"} , 
 	{ "Name" : "layer12_out", "interface" : "fifo", "bitwidth" : 288, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer10_out_dout sc_in sc_lv 416 signal 0 } 
	...
	{ layer12_out_din sc_out sc_lv 288 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer10_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":416, "type": "signal", "bundle":{"name": "layer10_out", "role": "dout" }} , 
 	...
 	{ "name": "layer12_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":288, "type": "signal", "bundle":{"name": "layer12_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer10_out { ap_fifo {  { layer10_out_dout fifo_data_out 0 416 }  { layer10_out_empty_n fifo_status_empty 0 1 }  { layer10_out_read fifo_data_in 1 1 }  { layer10_out_num_data_valid fifo_update 0 2 }  { layer10_out_fifo_cap fifo_data 0 2 } } }
	layer12_out { ap_fifo {  { layer12_out_din fifo_data_out 1 288 }  { layer12_out_full_n fifo_status_empty 0 1 }  { layer12_out_write fifo_data_in 1 1 }  { layer12_out_num_data_valid fifo_update 0 2 }  { layer12_out_fifo_cap fifo_data 0 2 } } }
}
