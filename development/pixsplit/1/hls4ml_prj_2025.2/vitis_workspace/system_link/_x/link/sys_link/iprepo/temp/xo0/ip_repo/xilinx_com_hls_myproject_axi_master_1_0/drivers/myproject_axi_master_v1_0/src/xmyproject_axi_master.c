...
void XMyproject_axi_master_Set_gmem_in0_ptr_input_layer_18(XMyproject_axi_master *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMyproject_axi_master_WriteReg(InstancePtr->Control_BaseAddress, XMYPROJECT_AXI_MASTER_CONTROL_ADDR_GMEM_IN0_PTR_INPUT_LAYER_18_DATA, (u32)(Data));
    XMyproject_axi_master_WriteReg(InstancePtr->Control_BaseAddress, XMYPROJECT_AXI_MASTER_CONTROL_ADDR_GMEM_IN0_PTR_INPUT_LAYER_18_DATA + 4, (u32)(Data >> 32));
}

u64 XMyproject_axi_master_Get_gmem_in0_ptr_input_layer_18(XMyproject_axi_master *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMyproject_axi_master_ReadReg(InstancePtr->Control_BaseAddress, XMYPROJECT_AXI_MASTER_CONTROL_ADDR_GMEM_IN0_PTR_INPUT_LAYER_18_DATA);
    Data += (u64)XMyproject_axi_master_ReadReg(InstancePtr->Control_BaseAddress, XMYPROJECT_AXI_MASTER_CONTROL_ADDR_GMEM_IN0_PTR_INPUT_LAYER_18_DATA + 4) << 32;
    return Data;
}
