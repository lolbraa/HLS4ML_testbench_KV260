...
struct relu_config4 : nnet::activ_config {
    ...
    static const unsigned table_size = 67108864;
    static const unsigned io_type = nnet::io_stream;
    static const unsigned reuse_factor = 1;
...
struct config12 : nnet::dense_config {
    ...
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef encoder_layer_accum_t accum_t;
    typedef encoder_layer_bias_t bias_t;
...
struct relu_config13 : nnet::activ_config {
    ...
    static const unsigned table_size = 4194304;
    static const unsigned io_type = nnet::io_stream;
    static const unsigned reuse_factor = 1;
    typedef encoder_layer_relu_table_t table_t;
};
...
struct config15 : nnet::dense_config {
    ...
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef dense_out_accum_t accum_t;
    typedef dense_out_bias_t bias_t;
