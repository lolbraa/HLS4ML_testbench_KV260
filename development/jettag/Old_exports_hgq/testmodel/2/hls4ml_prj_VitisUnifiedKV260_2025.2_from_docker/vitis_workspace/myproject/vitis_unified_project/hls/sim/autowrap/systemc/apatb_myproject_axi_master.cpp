...
#define AUTOTB_TVOUT_gmem_out0_ptr_layer5_out "../tv/cdatafile/c.myproject_axi_master.autotvout_gmem_out0_ptr_layer5_out.dat"
...
extern "C"
void apatb_myproject_axi_master_hw(void* __xlx_apatb_param_gmem_in0_ptr_linput, void* __xlx_apatb_param_gmem_out0_ptr_layer5_out, hls::sim::Byte<4> __xlx_apatb_param_batch_size)
{
  ...
  static hls::sim::Byte<4> __xlx_offset_byte_param_gmem_out0_ptr_layer5_out;
  static hls::sim::Register port1 {
    .name = "gmem_out0_ptr_layer5_out",
    .width = 32,
#ifdef POST_CHECK
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_gmem_out0_ptr_layer5_out),
#endif
  };
  port1.param = &__xlx_offset_byte_param_gmem_out0_ptr_layer5_out;
  ...
  port4.param = { __xlx_apatb_param_gmem_out0_ptr_layer5_out };
  port4.mname = { "gmem_out0_ptr_layer5_out" };
  port4.nbytes = { 20 };
  ...
  try {
    ...
    myproject_axi_master_hw_stub_wrapper(__xlx_apatb_param_gmem_in0_ptr_linput, __xlx_apatb_param_gmem_out0_ptr_layer5_out, __xlx_apatb_param_batch_size);
