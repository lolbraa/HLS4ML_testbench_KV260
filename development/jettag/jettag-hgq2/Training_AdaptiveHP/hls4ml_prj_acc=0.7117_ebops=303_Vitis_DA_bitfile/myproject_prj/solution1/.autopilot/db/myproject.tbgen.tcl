...
set ArgLastReadFirstWriteLatency {
	myproject {
		...
		layer12_out_3 {Type O LastRead -1 FirstWrite 3}
		layer12_out_4 {Type O LastRead -1 FirstWrite 3}}
...
set Spec2ImplPortList { 
	input_layer { ap_vld {  { input_layer_ap_vld in_vld 0 1 }  { input_layer in_data 0 128 } } }
