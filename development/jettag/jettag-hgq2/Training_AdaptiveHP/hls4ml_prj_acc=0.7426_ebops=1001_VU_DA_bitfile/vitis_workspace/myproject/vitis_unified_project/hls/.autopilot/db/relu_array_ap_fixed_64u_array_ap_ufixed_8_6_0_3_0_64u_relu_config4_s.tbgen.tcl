set moduleName relu_array_ap_fixed_64u_array_ap_ufixed_8_6_0_3_0_64u_relu_config4_s
set isTopModule 0
...
set cdfgNum 20
set C_modelName {relu<array<ap_fixed,64u>,array<ap_ufixed<8,6,0,3,0>,64u>,relu_config4>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer3_out int 768 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer3_out", "interface" : "fifo", "bitwidth" : 768, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer3_out_dout sc_in sc_lv 768 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer3_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":768, "type": "signal", "bundle":{"name": "layer3_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer3_out { ap_fifo {  { layer3_out_dout fifo_data_out 0 768 }  { layer3_out_empty_n fifo_status_empty 0 1 }  { layer3_out_read fifo_data_in 1 1 }  { layer3_out_num_data_valid fifo_update 0 2 }  { layer3_out_fifo_cap fifo_data 0 2 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_data_out 1 512 }  { layer4_out_full_n fifo_status_empty 0 1 }  { layer4_out_write fifo_data_in 1 1 }  { layer4_out_num_data_valid fifo_update 0 2 }  { layer4_out_fifo_cap fifo_data 0 2 } } }
}
