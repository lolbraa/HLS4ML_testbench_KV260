...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { model_input_stream_dout { I 256 vector } model_input_stream_empty_n { I 1 bit } model_input_stream_read { O 1 bit } model_input_stream_num_data_valid { I 2 vector } model_input_stream_fifo_cap { I 2 vector } } \
} "
}
