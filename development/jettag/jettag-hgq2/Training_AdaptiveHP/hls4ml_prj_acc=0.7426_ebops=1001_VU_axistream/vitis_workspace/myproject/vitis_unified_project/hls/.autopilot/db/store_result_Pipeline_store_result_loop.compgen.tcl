...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_axi_stream_ctlz_14_14_1_1 BINDTYPE {op} TYPE {ctlz} IMPL {auto}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { axi_output_stream_TREADY { I 1 bit } axi_output_stream_TDATA { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { axi_output_stream_TVALID { O 1 bit } axi_output_stream_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln31 \
    op interface \
    ports { add_ln31 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { model_output_stream_dout { I 80 vector } model_output_stream_empty_n { I 1 bit } model_output_stream_read { O 1 bit } model_output_stream_num_data_valid { I 2 vector } model_output_stream_fifo_cap { I 2 vector } } \
} "
}
...
set InstName myproject_axi_stream_flow_control_loop_pipe_sequential_init_U
set CompName myproject_axi_stream_flow_control_loop_pipe_sequential_init
