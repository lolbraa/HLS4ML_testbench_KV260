...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_myproject_axi_stream_1_0"]
...
dict set mem_topology_dict HP0 0
dict set mem_topology_dict HP1 1
dict set mem_topology_dict HP2 2
dict set mem_topology_dict HP3 3
dict set mem_topology_dict HPC1 4

set hw_platform_info [dict create \
  hw_platform_dir              ".local/hw_platform" \
  hw_platform_file             "/home/ncgadmin/Bachelor/HLS4ML_testbench_KV260/development/jettag/jettag-hgq2/Training_AdaptiveHP/hls4ml_prj_acc=0.7426_ebops=1001_VU_axistream/vitis_workspace/kv260/tcl_scripts/output/kv260_axi_all_platform.xsa" \
  ...
  hw_platform_dr_bd            "" \
  hw_platform_top_bd            ".local/hw_platform/prj/project_1.srcs/sources_1/bd/vitis_design/vitis_design.bd" \
  ...
  xpfm_file                    "/home/ncgadmin/Bachelor/HLS4ML_testbench_KV260/development/jettag/jettag-hgq2/Training_AdaptiveHP/hls4ml_prj_acc=0.7426_ebops=1001_VU_axistream/vitis_workspace/kv260/tcl_scripts/output/kv260_axi_all_platform.xsa" \
...
set config_info [dict create \
  ...
  run_script_map_file      "" \
  clbinary_name            "myproject" \
  kernels                  "myproject_axi_stream" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
  num_jobs_synth            8 \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/home/ncgadmin/Bachelor/HLS4ML_testbench_KV260/development/jettag/jettag-hgq2/Training_AdaptiveHP/hls4ml_prj_acc=0.7426_ebops=1001_VU_axistream/vitis_workspace/system_link/.ipcache" \
  user_board_repo           {} \
  user_bconn                {} \
