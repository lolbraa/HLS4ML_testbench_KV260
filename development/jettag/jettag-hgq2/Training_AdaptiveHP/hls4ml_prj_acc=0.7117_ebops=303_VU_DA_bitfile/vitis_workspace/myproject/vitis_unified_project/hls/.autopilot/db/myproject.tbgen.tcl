...
set portNum 13
set portList { 
	{ stream_in0_input_layer_dout sc_in sc_lv 128 signal 0 } 
...
set Spec2ImplPortList { 
	stream_in0_input_layer { ap_fifo {  { stream_in0_input_layer_dout fifo_data_out 0 128 }  { stream_in0_input_layer_empty_n fifo_status_empty 0 1 }  { stream_in0_input_layer_read fifo_data_in 1 1 } } }
