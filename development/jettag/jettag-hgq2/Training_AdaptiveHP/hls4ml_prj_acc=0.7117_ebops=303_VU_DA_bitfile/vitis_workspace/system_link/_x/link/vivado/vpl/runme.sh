...
HD_PWD='/work/development/jettag/jettag-hgq2/Training_AdaptiveHP/hls4ml_prj_acc=0.7117_ebops=303_VU_DA_bitfile/vitis_workspace/system_link/_x/link/vivado/vpl'
cd "$HD_PWD"
