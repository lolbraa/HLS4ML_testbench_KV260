...
typedef nnet::array<ap_fixed<10,5,AP_RND,AP_WRAP,0>, 16*1> input_layer_t;
typedef ap_fixed<17,9> dense_0_accum_t;
typedef nnet::array<ap_fixed<12,9>, 64*1> dense_0_t;
typedef ap_fixed<8,5> dense_0_weight_t;
typedef ap_fixed<7,3> dense_0_bias_t;
typedef ap_uint<1> layer3_index;
typedef nnet::array<ap_ufixed<8,6,AP_RND,AP_WRAP,0>, 64*1> dense_0_relu_t;
typedef ap_fixed<18,8> dense_0_relu_table_t;
typedef ap_fixed<16,11> dense_1_accum_t;
typedef nnet::array<ap_fixed<14,11>, 32*1> dense_1_t;
typedef ap_fixed<7,4> dense_1_weight_t;
...
typedef ap_fixed<15,8> dense_3_accum_t;
typedef nnet::array<ap_fixed<15,8>, 5*1> result_t;
typedef ap_fixed<6,1> dense_3_weight_t;
typedef ap_fixed<5,0> dense_3_bias_t;
