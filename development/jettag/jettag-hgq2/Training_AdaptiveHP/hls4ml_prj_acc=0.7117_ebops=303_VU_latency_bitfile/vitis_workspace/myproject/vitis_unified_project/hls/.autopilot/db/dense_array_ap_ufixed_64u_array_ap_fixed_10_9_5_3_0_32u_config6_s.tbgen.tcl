set moduleName dense_array_ap_ufixed_64u_array_ap_fixed_10_9_5_3_0_32u_config6_s
set isTopModule 0
...
set cdfgNum 20
set C_modelName {dense<array<ap_ufixed,64u>,array<ap_fixed<10,9,5,3,0>,32u>,config6>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer4_out int 448 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 448, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer4_out_dout sc_in sc_lv 448 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer4_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":448, "type": "signal", "bundle":{"name": "layer4_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer4_out { ap_fifo {  { layer4_out_dout fifo_data_out 0 448 }  { layer4_out_empty_n fifo_status_empty 0 1 }  { layer4_out_read fifo_data_in 1 1 }  { layer4_out_num_data_valid fifo_update 0 2 }  { layer4_out_fifo_cap fifo_data 0 2 } } }
	layer6_out { ap_fifo {  { layer6_out_din fifo_data_out 1 320 }  { layer6_out_full_n fifo_status_empty 0 1 }  { layer6_out_write fifo_data_in 1 1 }  { layer6_out_num_data_valid fifo_update 0 2 }  { layer6_out_fifo_cap fifo_data 0 2 } } }
}
