set moduleName dense_array_ap_ufixed_64u_array_ap_fixed_16_13_5_3_0_32u_config6_s
set isTopModule 0
...
set cdfgNum 20
set C_modelName {dense<array<ap_ufixed,64u>,array<ap_fixed<16,13,5,3,0>,32u>,config6>}
...
set Spec2ImplPortList { 
	...
	layer6_out { ap_fifo {  { layer6_out_din fifo_data_out 1 512 }  { layer6_out_full_n fifo_status_empty 0 1 }  { layer6_out_write fifo_data_in 1 1 }  { layer6_out_num_data_valid fifo_update 0 2 }  { layer6_out_fifo_cap fifo_data 0 2 } } }
}
