...
HD_PWD='/work/development/jettag/jettag-hgq2/Training_FixedHP/hls4ml_prj_acc=0.7659_ebops=21624_VU_latency_bitfile/vitis_workspace/system_link/_x/link/vivado/vpl'
cd "$HD_PWD"
