...
set C_modelArgList {
	...
	{ layer8_out int 190 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "layer8_out", "interface" : "fifo", "bitwidth" : 190, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer8_out_din sc_out sc_lv 190 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer8_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":190, "type": "signal", "bundle":{"name": "layer8_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	layer8_out { ap_fifo {  { layer8_out_din fifo_data_out 1 190 }  { layer8_out_full_n fifo_status_empty 0 1 }  { layer8_out_write fifo_data_in 1 1 }  { layer8_out_num_data_valid fifo_update 0 2 }  { layer8_out_fifo_cap fifo_data 0 2 } } }
}
