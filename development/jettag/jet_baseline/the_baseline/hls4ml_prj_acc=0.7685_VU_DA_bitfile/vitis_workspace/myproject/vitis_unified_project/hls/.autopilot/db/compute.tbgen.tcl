...
set C_modelArgList {
	...
	{ stream_in0_input_layer int 256 regular {fifo 0 volatile } {global 0}  }
	{ stream_out0_layer9_out int 80 regular {fifo 1 volatile } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "batch_size", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "stream_in0_input_layer", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "stream_out0_layer9_out", "interface" : "fifo", "bitwidth" : 80, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ stream_in0_input_layer_dout sc_in sc_lv 256 signal 2 } 
	...
	{ stream_out0_layer9_out_din sc_out sc_lv 80 signal 3 } 
	{ stream_out0_layer9_out_full_n sc_in sc_logic 1 signal 3 } 
	{ stream_out0_layer9_out_write sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_in0_input_layer_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "stream_in0_input_layer", "role": "dout" }} , 
 	...
 	{ "name": "stream_out0_layer9_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":80, "type": "signal", "bundle":{"name": "stream_out0_layer9_out", "role": "din" }} , 
 	{ "name": "stream_out0_layer9_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_out0_layer9_out", "role": "full_n" }} , 
 	{ "name": "stream_out0_layer9_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_out0_layer9_out", "role": "write" }} , 
...
set ArgLastReadFirstWriteLatency {
	compute {
		...
		stream_out0_layer9_out {Type O LastRead -1 FirstWrite 7}}
	myproject {
		stream_in0_input_layer {Type I LastRead 0 FirstWrite -1}
		invert_table {Type I LastRead -1 FirstWrite -1}
		stream_out0_layer9_out {Type O LastRead -1 FirstWrite 7}}
	dense_array_ap_fixed_16u_array_ap_fixed_37_17_5_3_0_64u_config2_s {
	...
	dense_array_ap_fixed_32u_array_ap_fixed_38_18_5_3_0_32u_config6_s {
	...
	dense_array_ap_fixed_32u_array_ap_fixed_38_18_5_3_0_5u_config8_s {
	...
	init_exp_table_ap_ufixed_37_17_5_3_0_softmax_config9_s {
		table_out {Type O LastRead -1 FirstWrite 15}}}
...
set Spec2ImplPortList { 
	...
	stream_in0_input_layer { ap_fifo {  { stream_in0_input_layer_dout fifo_data_out 0 256 }  { stream_in0_input_layer_empty_n fifo_status_empty 0 1 }  { stream_in0_input_layer_read fifo_data_in 1 1 }  { stream_in0_input_layer_num_data_valid fifo_update 0 8 }  { stream_in0_input_layer_fifo_cap fifo_data 0 8 } } }
	stream_out0_layer9_out { ap_fifo {  { stream_out0_layer9_out_din fifo_data_out 1 80 }  { stream_out0_layer9_out_full_n fifo_status_empty 0 1 }  { stream_out0_layer9_out_write fifo_data_in 1 1 }  { stream_out0_layer9_out_num_data_valid fifo_update 0 8 }  { stream_out0_layer9_out_fifo_cap fifo_data 0 8 } } }
}
