...
set portNum 13
set portList { 
	{ stream_in0_input_layer_dout sc_in sc_lv 256 signal 0 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1067", "Max" : "1067"}
...
set Spec2ImplPortList { 
	stream_in0_input_layer { ap_fifo {  { stream_in0_input_layer_dout fifo_data_out 0 256 }  { stream_in0_input_layer_empty_n fifo_status_empty 0 1 }  { stream_in0_input_layer_read fifo_data_in 1 1 } } }
	stream_out0_layer9_out { ap_fifo {  { stream_out0_layer9_out_din fifo_data_out 1 80 }  { stream_out0_layer9_out_full_n fifo_status_empty 0 1 }  { stream_out0_layer9_out_write fifo_data_in 1 1 } } }
}
