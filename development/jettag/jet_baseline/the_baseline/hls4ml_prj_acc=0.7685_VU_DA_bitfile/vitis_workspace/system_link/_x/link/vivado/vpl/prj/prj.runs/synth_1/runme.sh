...
HD_PWD='/work/development/jettag/jet_baseline/the_baseline/hls4ml_prj_acc=0.7685_VU_DA_bitfile/vitis_workspace/system_link/_x/link/vivado/vpl/prj/prj.runs/synth_1'
cd "$HD_PWD"
