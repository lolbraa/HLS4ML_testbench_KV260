...
void compute(hls::stream<input_t>& stream_in0_input_layer, hls::stream<result_t>& stream_out0_layer9_out, int batch_size) {
    for (int q = 0; q < batch_size; q++) {
    myproject(stream_in0_input_layer, stream_out0_layer9_out);
    }
}
...
void myproject_axi_master(
    ...
    compute(stream_in0_input_layer, stream_out0_layer9_out, batch_size);
