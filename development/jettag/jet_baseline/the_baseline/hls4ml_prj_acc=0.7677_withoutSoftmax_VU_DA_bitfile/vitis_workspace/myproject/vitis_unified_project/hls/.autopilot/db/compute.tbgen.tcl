...
set C_modelArgList {
	...
	{ stream_out0_layer8_out int 320 regular {fifo 1 volatile } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "batch_size", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "stream_out0_layer8_out", "interface" : "fifo", "bitwidth" : 320, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ stream_out0_layer8_out_din sc_out sc_lv 320 signal 3 } 
	{ stream_out0_layer8_out_full_n sc_in sc_logic 1 signal 3 } 
	{ stream_out0_layer8_out_write sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_out0_layer8_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":320, "type": "signal", "bundle":{"name": "stream_out0_layer8_out", "role": "din" }} , 
 	{ "name": "stream_out0_layer8_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_out0_layer8_out", "role": "full_n" }} , 
 	{ "name": "stream_out0_layer8_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_out0_layer8_out", "role": "write" }} , 
...
set ArgLastReadFirstWriteLatency {
	compute {
		...
		stream_out0_layer8_out {Type O LastRead -1 FirstWrite 3}}
	myproject {
		stream_in0_input_layer {Type I LastRead 0 FirstWrite -1}
		stream_out0_layer8_out {Type O LastRead -1 FirstWrite 3}}
...
set Spec2ImplPortList { 
	...
	stream_out0_layer8_out { ap_fifo {  { stream_out0_layer8_out_din fifo_data_out 1 320 }  { stream_out0_layer8_out_full_n fifo_status_empty 0 1 }  { stream_out0_layer8_out_write fifo_data_in 1 1 }  { stream_out0_layer8_out_num_data_valid fifo_update 0 8 }  { stream_out0_layer8_out_fifo_cap fifo_data 0 8 } } }
}
