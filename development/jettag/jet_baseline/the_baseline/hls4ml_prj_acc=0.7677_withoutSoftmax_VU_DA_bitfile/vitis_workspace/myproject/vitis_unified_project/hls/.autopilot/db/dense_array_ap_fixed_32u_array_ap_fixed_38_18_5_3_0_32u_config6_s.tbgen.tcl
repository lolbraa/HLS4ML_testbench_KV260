set moduleName dense_array_ap_fixed_32u_array_ap_fixed_38_18_5_3_0_32u_config6_s
set isTopModule 0
...
set cdfgNum 20
set C_modelName {dense<array<ap_fixed,32u>,array<ap_fixed<38,18,5,3,0>,32u>,config6>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer5_out int 512 regular {fifo 0 volatile }  }
	{ layer6_out int 1216 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 1216, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer6_out_din sc_out sc_lv 1216 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer6_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1216, "type": "signal", "bundle":{"name": "layer6_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer5_out { ap_fifo {  { layer5_out_dout fifo_data_out 0 512 }  { layer5_out_empty_n fifo_status_empty 0 1 }  { layer5_out_read fifo_data_in 1 1 }  { layer5_out_num_data_valid fifo_update 0 2 }  { layer5_out_fifo_cap fifo_data 0 2 } } }
	layer6_out { ap_fifo {  { layer6_out_din fifo_data_out 1 1216 }  { layer6_out_full_n fifo_status_empty 0 1 }  { layer6_out_write fifo_data_in 1 1 }  { layer6_out_num_data_valid fifo_update 0 2 }  { layer6_out_fifo_cap fifo_data 0 2 } } }
}
