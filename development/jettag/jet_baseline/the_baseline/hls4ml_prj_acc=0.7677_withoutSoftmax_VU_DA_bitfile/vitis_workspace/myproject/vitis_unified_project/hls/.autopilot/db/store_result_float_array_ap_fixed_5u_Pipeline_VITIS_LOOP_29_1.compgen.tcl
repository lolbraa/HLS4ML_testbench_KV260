...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_axi_master_ctlz_38_38_1_1 BINDTYPE {op} TYPE {ctlz} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_axi_master_bitselect_1ns_38ns_6ns_1_1_1 BINDTYPE {op} TYPE {bitselect} IMPL {auto}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out0_layer8_out_dout { I 320 vector } stream_out0_layer8_out_empty_n { I 1 bit } stream_out0_layer8_out_read { O 1 bit } stream_out0_layer8_out_num_data_valid { I 8 vector } stream_out0_layer8_out_fifo_cap { I 8 vector } } \
} "
}
