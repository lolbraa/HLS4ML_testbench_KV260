...
set Spec2ImplPortList { 
	...
	stream_out0_layer8_out { ap_fifo {  { stream_out0_layer8_out_din fifo_data_out 1 320 }  { stream_out0_layer8_out_full_n fifo_status_empty 0 1 }  { stream_out0_layer8_out_write fifo_data_in 1 1 } } }
}
