; ModuleID = '/work/development/jettag/jettag-qkeras/Qkeras_Pruned/hls4ml_prj_acc=0.7298_VU_latency_bitfile/vitis_workspace/myproject/vitis_unified_project/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %1 = bitcast float* %gmem_out0_ptr_layer13_out to [5 x float]*
  %gmem_out0_ptr_layer13_out_copy = alloca [5 x float], align 512
  call fastcc void @copy_in([16 x float]* nonnull %0, [16 x float]* nonnull align 512 %gmem_in0_ptr_input_layer_copy, [5 x float]* nonnull %1, [5 x float]* nonnull align 512 %gmem_out0_ptr_layer13_out_copy)
  call void @apatb_myproject_axi_master_hw([16 x float]* %gmem_in0_ptr_input_layer_copy, [5 x float]* %gmem_out0_ptr_layer13_out_copy, i32 %batch_size)
  call void @copy_back([16 x float]* %0, [16 x float]* %gmem_in0_ptr_input_layer_copy, [5 x float]* %1, [5 x float]* %gmem_out0_ptr_layer13_out_copy)
  ret void
}
