set moduleName dense_array_ap_ufixed_64u_array_ap_fixed_11_8_5_3_0_32u_config5_s
set isTopModule 0
...
set cdfgNum 22
set C_modelName {dense<array<ap_ufixed,64u>,array<ap_fixed<11,8,5,3,0>,32u>,config5>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer4_out int 128 regular {fifo 0 volatile }  }
	{ layer5_out int 352 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 352, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer4_out_dout sc_in sc_lv 128 signal 0 } 
	...
	{ layer5_out_din sc_out sc_lv 352 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer4_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer4_out", "role": "dout" }} , 
 	...
 	{ "name": "layer5_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":352, "type": "signal", "bundle":{"name": "layer5_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer4_out { ap_fifo {  { layer4_out_dout fifo_data_out 0 128 }  { layer4_out_empty_n fifo_status_empty 0 1 }  { layer4_out_read fifo_data_in 1 1 }  { layer4_out_num_data_valid fifo_update 0 2 }  { layer4_out_fifo_cap fifo_data 0 2 } } }
	layer5_out { ap_fifo {  { layer5_out_din fifo_data_out 1 352 }  { layer5_out_full_n fifo_status_empty 0 1 }  { layer5_out_write fifo_data_in 1 1 }  { layer5_out_num_data_valid fifo_update 0 2 }  { layer5_out_fifo_cap fifo_data 0 2 } } }
}
