set moduleName relu_array_ap_fixed_32u_array_ap_ufixed_2_0_4_0_0_32u_relu_config10_s
set isTopModule 0
...
set cdfgNum 22
set C_modelName {relu<array<ap_fixed,32u>,array<ap_ufixed<2,0,4,0,0>,32u>,relu_config10>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer8_out int 320 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer8_out", "interface" : "fifo", "bitwidth" : 320, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer8_out_dout sc_in sc_lv 320 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer8_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":320, "type": "signal", "bundle":{"name": "layer8_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer8_out { ap_fifo {  { layer8_out_dout fifo_data_out 0 320 }  { layer8_out_empty_n fifo_status_empty 0 1 }  { layer8_out_read fifo_data_in 1 1 }  { layer8_out_num_data_valid fifo_update 0 2 }  { layer8_out_fifo_cap fifo_data 0 2 } } }
	layer10_out { ap_fifo {  { layer10_out_din fifo_data_out 1 64 }  { layer10_out_full_n fifo_status_empty 0 1 }  { layer10_out_write fifo_data_in 1 1 }  { layer10_out_num_data_valid fifo_update 0 2 }  { layer10_out_fifo_cap fifo_data 0 2 } } }
}
