...
set C_modelArgList {
	{ layer11_out int 50 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer11_out", "interface" : "fifo", "bitwidth" : 50, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer11_out_dout sc_in sc_lv 50 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer11_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":50, "type": "signal", "bundle":{"name": "layer11_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer11_out { ap_fifo {  { layer11_out_dout fifo_data_out 0 50 }  { layer11_out_empty_n fifo_status_empty 0 1 }  { layer11_out_read fifo_data_in 1 1 }  { layer11_out_num_data_valid fifo_update 0 2 }  { layer11_out_fifo_cap fifo_data 0 2 } } }
