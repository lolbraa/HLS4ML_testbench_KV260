set moduleName dense_array_ap_ufixed_32u_array_ap_fixed_10_7_5_3_0_32u_config8_s
set isTopModule 0
...
set cdfgNum 22
set C_modelName {dense<array<ap_ufixed,32u>,array<ap_fixed<10,7,5,3,0>,32u>,config8>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer7_out int 64 regular {fifo 0 volatile }  }
	{ layer8_out int 320 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "layer8_out", "interface" : "fifo", "bitwidth" : 320, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer8_out_din sc_out sc_lv 320 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer8_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":320, "type": "signal", "bundle":{"name": "layer8_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_data_out 0 64 }  { layer7_out_empty_n fifo_status_empty 0 1 }  { layer7_out_read fifo_data_in 1 1 }  { layer7_out_num_data_valid fifo_update 0 2 }  { layer7_out_fifo_cap fifo_data 0 2 } } }
	layer8_out { ap_fifo {  { layer8_out_din fifo_data_out 1 320 }  { layer8_out_full_n fifo_status_empty 0 1 }  { layer8_out_write fifo_data_in 1 1 }  { layer8_out_num_data_valid fifo_update 0 2 }  { layer8_out_fifo_cap fifo_data 0 2 } } }
}
