...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_in0_input_layer_1_dout { I 256 vector } stream_in0_input_layer_1_empty_n { I 1 bit } stream_in0_input_layer_1_read { O 1 bit } stream_in0_input_layer_1_num_data_valid { I 8 vector } stream_in0_input_layer_1_fifo_cap { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out0_layer12_out_din { O 160 vector } stream_out0_layer12_out_full_n { I 1 bit } stream_out0_layer12_out_write { O 1 bit } stream_out0_layer12_out_num_data_valid { I 8 vector } stream_out0_layer12_out_fifo_cap { I 8 vector } } \
} "
}
