#ifndef TEST-HGQ2_1_HLS4ML_PRJ_VITIS_BRIDGE_H_
#define TEST-HGQ2_1_HLS4ML_PRJ_VITIS_BRIDGE_H_

#include "firmware/test-hgq2_1_hls4ml_prj_Vitis.h"
...
void test-hgq2_1_hls4ml_prj_Vitis_float(
    float *input_layer,
    float *layer13_out
) {
    ...
    test-hgq2_1_hls4ml_prj_Vitis(input_layer_ap,layer13_out_ap);

    nnet::convert_data<result_t, float, 5>(layer13_out_ap, layer13_out);
}

void test-hgq2_1_hls4ml_prj_Vitis_double(
    double *input_layer,
    double *layer13_out
) {
