...
void hgq2_1_hls4ml_prj_Vitis_2023_da4ml(
    ...
    #pragma HLS INTERFACE ap_vld port=input_layer_1,layer12_out 
    #pragma HLS PIPELINE
    ...
    nnet::dense_da_3<input_layer_1_t, dense_0_t>(input_layer_1, layer3_out); // dense_0
    ...
    nnet::dense_da_12<dense_2_relu_t, result_t>(layer10_out, layer12_out); // dense_3
