...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myproject_axi_master.autotvin_gmem_in0.dat"
         "c.myproject_axi_master.autotvin_gmem_in0_ptr_input_layer_1.dat"
         "c.myproject_axi_master.autotvin_gmem_out0_ptr_layer12_out.dat"
         "c.myproject_axi_master.autotvin_batch_size.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject_axi_master.autotvout_gmem_out0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
