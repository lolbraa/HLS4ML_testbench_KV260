set moduleName relu_array_ap_fixed_32u_array_ap_fixed_16_6_5_3_0_32u_relu_config10_s
set isTopModule 0
...
set cdfgNum 16
set C_modelName {relu<array<ap_fixed,32u>,array<ap_fixed<16,6,5,3,0>,32u>,relu_config10>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer8_out int 512 regular {fifo 0 volatile }  }
	{ layer10_out int 512 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer8_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "layer10_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer10_out_din sc_out sc_lv 512 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer10_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "layer10_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer8_out { ap_fifo {  { layer8_out_dout fifo_data_out 0 512 }  { layer8_out_empty_n fifo_status_empty 0 1 }  { layer8_out_read fifo_data_in 1 1 }  { layer8_out_num_data_valid fifo_update 0 2 }  { layer8_out_fifo_cap fifo_data 0 2 } } }
	layer10_out { ap_fifo {  { layer10_out_din fifo_data_out 1 512 }  { layer10_out_full_n fifo_status_empty 0 1 }  { layer10_out_write fifo_data_in 1 1 }  { layer10_out_num_data_valid fifo_update 0 2 }  { layer10_out_fifo_cap fifo_data 0 2 } } }
}
