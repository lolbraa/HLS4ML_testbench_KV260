...
HD_PWD='/work/development/testmodel/2/hls4ml_prj_VitisUnifiedKV260_2025.2_from_docker/vitis_workspace/system_link/_x/link/vivado/vpl/prj/prj.runs/synth_1'
cd "$HD_PWD"
