set moduleName relu_array_ap_fixed_32u_array_ap_fixed_10_9_0_3_0_32u_relu_config7_s
set isTopModule 0
...
set cdfgNum 20
set C_modelName {relu<array<ap_fixed,32u>,array<ap_fixed<10,9,0,3,0>,32u>,relu_config7>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer6_out int 480 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 480, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer6_out_dout sc_in sc_lv 480 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer6_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":480, "type": "signal", "bundle":{"name": "layer6_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_out 0 480 }  { layer6_out_empty_n fifo_status_empty 0 1 }  { layer6_out_read fifo_data_in 1 1 }  { layer6_out_num_data_valid fifo_update 0 2 }  { layer6_out_fifo_cap fifo_data 0 2 } } }
	layer7_out { ap_fifo {  { layer7_out_din fifo_data_out 1 320 }  { layer7_out_full_n fifo_status_empty 0 1 }  { layer7_out_write fifo_data_in 1 1 }  { layer7_out_num_data_valid fifo_update 0 2 }  { layer7_out_fifo_cap fifo_data 0 2 } } }
}
