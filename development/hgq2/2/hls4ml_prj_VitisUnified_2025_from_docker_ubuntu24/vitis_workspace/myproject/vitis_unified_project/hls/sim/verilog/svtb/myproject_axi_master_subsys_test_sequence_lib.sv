                    ...
                    fork
                        ...
                        begin
                            ...
                            for(int i=0; i<100; i++) begin
                                logic[63:0] data64bit_gmem_in0_ptr_input_layer_1[$];
                                logic[32-1:0] databusbit_gmem_in0_ptr_input_layer_1[$];
                                logic[63:0] data64bit_gmem_out0_ptr_layer12_out[$];
                                logic[32-1:0] databusbit_gmem_out0_ptr_layer12_out[$];
                                logic[63:0] data64bit_batch_size[$];
                                logic[32-1:0] databusbit_batch_size[$];
                                data64bit_gmem_in0_ptr_input_layer_1.delete(); databusbit_gmem_in0_ptr_input_layer_1.delete();
                                axi_master_wr_control_seq.StableAxiliteNoUpdate=0;
                                for(int j=0; j < (64+32-1)/32; j++) begin
                                    data64bit_gmem_in0_ptr_input_layer_1.push_back( ((refm.mem_blk_pages_gmem_in0.maxi_bundlevar_offset["gmem_in0_ptr_input_layer_1"]+refm.mem_blk_pages_gmem_in0.page_ofst[refm.mem_blk_pages_gmem_in0.rd_page_idx])>>(j*32)) & (2**32-1) );
                                end
                                foreach(data64bit_gmem_in0_ptr_input_layer_1[s]) databusbit_gmem_in0_ptr_input_layer_1[s]=data64bit_gmem_in0_ptr_input_layer_1[s][32-1:0];
                                axi_master_wr_control_seq.StableAxiliteNoUpdate=1;
                                axi_master_wr_control_seq.datamerge_inavg(databusbit_gmem_in0_ptr_input_layer_1, 0, 16, 1);
                                data64bit_gmem_out0_ptr_layer12_out.delete(); databusbit_gmem_out0_ptr_layer12_out.delete();
                                axi_master_wr_control_seq.StableAxiliteNoUpdate=0;
                                for(int j=0; j < (64+32-1)/32; j++) begin
                                    data64bit_gmem_out0_ptr_layer12_out.push_back( ((refm.mem_blk_pages_gmem_out0.maxi_bundlevar_offset["gmem_out0_ptr_layer12_out"]+refm.mem_blk_pages_gmem_out0.page_ofst[refm.mem_blk_pages_gmem_out0.rd_page_idx])>>(j*32)) & (2**32-1) );
                                end
                                foreach(data64bit_gmem_out0_ptr_layer12_out[s]) databusbit_gmem_out0_ptr_layer12_out[s]=data64bit_gmem_out0_ptr_layer12_out[s][32-1:0];
                                axi_master_wr_control_seq.StableAxiliteNoUpdate=1;
                                axi_master_wr_control_seq.datamerge_inavg(databusbit_gmem_out0_ptr_layer12_out, 0, 28, 1);
