; ModuleID = '/home/ncgadmin/Bachelor/HLS4ML_testbench_KV260/development/hgq2/1/hls4ml_prj_Vitis_2023_latency_reusefactor4/hgq2_1_hls4ml_prj_Vitis_2023_latency_reusefactor4_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_hgq2_1_hls4ml_prj_Vitis_2023_latency_reusefactor4_ir(%"struct.ap_fixed<27, 19, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %input_layer, %"struct.ap_fixed<9, 3, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="5" "partition" %layer13_out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_hgq2_1_hls4ml_prj_Vitis_2023_latency_reusefactor4_hw(i432* %input_layer_copy3, i9* %layer13_out_copy_0, i9* %layer13_out_copy_1, i9* %layer13_out_copy_2, i9* %layer13_out_copy_3, i9* %layer13_out_copy_4)
...
declare void @apatb_hgq2_1_hls4ml_prj_Vitis_2023_latency_reusefactor4_hw(i432*, i9*, i9*, i9*, i9*, i9*)
...
define void @hgq2_1_hls4ml_prj_Vitis_2023_latency_reusefactor4_hw_stub_wrapper(i432*, i9*, i9*, i9*, i9*, i9*) #6 {
entry:
  ...
  call void @hgq2_1_hls4ml_prj_Vitis_2023_latency_reusefactor4_hw_stub(%"struct.ap_fixed<27, 19, AP_TRN, AP_WRAP, 0>"* %8, %"struct.ap_fixed<9, 3, AP_TRN, AP_WRAP, 0>"* %9)
...
declare void @hgq2_1_hls4ml_prj_Vitis_2023_latency_reusefactor4_hw_stub(%"struct.ap_fixed<27, 19, AP_TRN, AP_WRAP, 0>"*, %"struct.ap_fixed<9, 3, AP_TRN, AP_WRAP, 0>"*)
