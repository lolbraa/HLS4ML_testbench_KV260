...
AUTOPILOT_ROOT := /usr/lib/AMD/2025.2/Vitis
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /usr/lib/AMD/2025.2/Vitis/tps/lnx64/gcc-8.3.0/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
AP_CLANG_PATH := ${AUTOPILOT_ROOT}/lnx64/tools/clang-16/bin
TOOLCHAIN += --gcc-toolchain=/usr/lib/AMD/2025.2/Vitis/tps/lnx64/gcc-8.3.0
LFLAG += --gcc-toolchain=/usr/lib/AMD/2025.2/Vitis/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/myproject_axi_master.cpp_pre.cpp.tb.o : myproject_axi_master.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling myproject_axi_master.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c -std=c++0x $(IFLAG) $(DFLAG) $< -o $@; \
