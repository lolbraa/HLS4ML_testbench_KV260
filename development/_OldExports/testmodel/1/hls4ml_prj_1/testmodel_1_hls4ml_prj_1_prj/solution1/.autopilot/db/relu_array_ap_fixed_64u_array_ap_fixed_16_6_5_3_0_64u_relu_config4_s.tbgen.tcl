set moduleName relu_array_ap_fixed_64u_array_ap_fixed_16_6_5_3_0_64u_relu_config4_s
set isTopModule 0
...
set cdfgNum 16
set C_modelName {relu<array<ap_fixed,64u>,array<ap_fixed<16,6,5,3,0>,64u>,relu_config4>}
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_data_out 0 1024 }  { layer2_out_empty_n fifo_status_empty 0 1 }  { layer2_out_read fifo_data_in 1 1 }  { layer2_out_num_data_valid fifo_update 0 2 }  { layer2_out_fifo_cap fifo_data 0 2 } } }
