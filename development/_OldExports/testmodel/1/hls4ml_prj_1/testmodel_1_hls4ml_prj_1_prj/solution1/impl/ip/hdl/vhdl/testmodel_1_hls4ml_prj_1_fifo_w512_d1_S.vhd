...
entity testmodel_1_hls4ml_prj_1_fifo_w512_d1_S is 
    generic (
...
architecture rtl of testmodel_1_hls4ml_prj_1_fifo_w512_d1_S is
...
------------------------Component----------------------
    component testmodel_1_hls4ml_prj_1_fifo_w512_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 512;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
...
begin
----------------------- Instantiation -----------------------
    U_testmodel_1_hls4ml_prj_1_fifo_w512_d1_S_ShiftReg : testmodel_1_hls4ml_prj_1_fifo_w512_d1_S_ShiftReg
    generic map (
...
entity testmodel_1_hls4ml_prj_1_fifo_w512_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 512;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end testmodel_1_hls4ml_prj_1_fifo_w512_d1_S_ShiftReg;

architecture rtl of testmodel_1_hls4ml_prj_1_fifo_w512_d1_S_ShiftReg is
