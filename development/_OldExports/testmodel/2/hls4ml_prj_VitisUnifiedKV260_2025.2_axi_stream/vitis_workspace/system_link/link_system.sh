...
v++ -l -t hw --platform ../kv260/tcl_scripts/output/kv260_axi_all_platform.xsa ../myproject/vitis_unified_project/myproject_axi_stream.xo --config link_system.cfg -o myproject.xclbin --save-temps
