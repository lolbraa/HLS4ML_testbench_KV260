...
set portList { 
	...
	{ model_input_stream_dout sc_in sc_lv 256 signal 2 } 
	{ model_input_stream_empty_n sc_in sc_logic 1 signal 2 } 
	{ model_input_stream_read sc_out sc_logic 1 signal 2 } 
	{ model_input_stream_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ model_input_stream_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ model_output_stream_din sc_out sc_lv 80 signal 3 } 
	{ model_output_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ model_output_stream_write sc_out sc_logic 1 signal 3 } 
	{ model_output_stream_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ model_output_stream_fifo_cap sc_in sc_lv 2 signal 3 } 
}
set NewPortList {[ 
...
set ArgLastReadFirstWriteLatency {
	compute {
		...
		model_output_stream {Type O LastRead -1 FirstWrite 4}}
	myproject {
		model_input_stream {Type I LastRead 0 FirstWrite -1}
		exp_table {Type I LastRead -1 FirstWrite -1}
		invert_table {Type I LastRead -1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	model_input_stream { ap_fifo {  { model_input_stream_dout fifo_data_out 0 256 }  { model_input_stream_empty_n fifo_status_empty 0 1 }  { model_input_stream_read fifo_data_in 1 1 }  { model_input_stream_num_data_valid fifo_update 0 2 }  { model_input_stream_fifo_cap fifo_data 0 2 } } }
	model_output_stream { ap_fifo {  { model_output_stream_din fifo_data_out 1 80 }  { model_output_stream_full_n fifo_status_empty 0 1 }  { model_output_stream_write fifo_data_in 1 1 }  { model_output_stream_num_data_valid fifo_update 0 2 }  { model_output_stream_fifo_cap fifo_data 0 2 } } }
}
