...
set Spec2ImplPortList { 
	...
	layer4_out { ap_fifo {  { layer4_out_din fifo_data_out 1 80 }  { layer4_out_full_n fifo_status_empty 0 1 }  { layer4_out_write fifo_data_in 1 1 }  { layer4_out_num_data_valid fifo_update 0 2 }  { layer4_out_fifo_cap fifo_data 0 2 } } }
}
