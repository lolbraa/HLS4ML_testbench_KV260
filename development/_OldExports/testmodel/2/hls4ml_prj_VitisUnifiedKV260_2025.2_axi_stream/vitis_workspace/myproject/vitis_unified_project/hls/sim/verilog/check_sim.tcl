...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myproject_axi_stream.autotvin_axi_input_stream_V_data_V.dat"
         "c.myproject_axi_stream.autotvin_axi_input_stream_V_keep_V.dat"
         "c.myproject_axi_stream.autotvin_axi_input_stream_V_strb_V.dat"
         "c.myproject_axi_stream.autotvin_axi_input_stream_V_last_V.dat"
         "c.myproject_axi_stream.autotvin_batch_size.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject_axi_stream.autotvout_axi_output_stream_V_data_V.dat"
         "rtl.myproject_axi_stream.autotvout_axi_output_stream_V_keep_V.dat"
         "rtl.myproject_axi_stream.autotvout_axi_output_stream_V_strb_V.dat"
         "rtl.myproject_axi_stream.autotvout_axi_output_stream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
