...
set Spec2ImplPortList { 
	stream_in0_linput { ap_fifo {  { stream_in0_linput_dout fifo_data_out 0 256 }  { stream_in0_linput_empty_n fifo_status_empty 0 1 }  { stream_in0_linput_read fifo_data_in 1 1 } } }
	stream_out0_layer5_out { ap_fifo {  { stream_out0_layer5_out_din fifo_data_out 1 80 }  { stream_out0_layer5_out_full_n fifo_status_empty 0 1 }  { stream_out0_layer5_out_write fifo_data_in 1 1 } } }
}
