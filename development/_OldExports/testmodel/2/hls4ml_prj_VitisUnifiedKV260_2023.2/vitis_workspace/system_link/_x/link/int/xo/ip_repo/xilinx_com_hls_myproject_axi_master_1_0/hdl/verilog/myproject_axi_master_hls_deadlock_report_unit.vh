    ...
    function [1176:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                ...
                5 : begin
                    proc_path = "myproject_axi_master_myproject_axi_master.compute_U0.grp_myproject_fu_66.dense_array_ap_fixed_64u_array_ap_fixed_16_6_5_3_0_5u_config4_U0";
                end
                6 : begin
                    proc_path = "myproject_axi_master_myproject_axi_master.compute_U0.grp_myproject_fu_66.softmax_array_array_ap_fixed_16_6_5_3_0_5u_softmax_config5_U0";
                end
                7 : begin
                ...
                0 : begin
                    ...
                    7: begin
                        if (~entry_proc_U0.gmem_out0_ptr_layer5_out_c_blk_n) begin
                            ...
                            else if (~gmem_out0_ptr_layer5_out_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'myproject_axi_master_myproject_axi_master.gmem_out0_ptr_layer5_out_c_U' read by process 'myproject_axi_master_myproject_axi_master.store_result_float_array_ap_fixed_16_6_5_3_0_5u_U0'");
                                $fdisplay(fp, "Dependence_Channel_path myproject_axi_master_myproject_axi_master.gmem_out0_ptr_layer5_out_c_U");
                ...
                2 : begin
                    ...
                    7: begin
                        ...
                        if (~compute_U0.grp_myproject_fu_66.softmax_array_array_ap_fixed_16_6_5_3_0_5u_softmax_config5_U0.grp_softmax_stable_array_array_ap_fixed_16_6_5_3_0_5u_softmax_config5_s_fu_20.stream_out0_layer5_out_blk_n) begin
                            ...
                            else if (~stream_out0_layer5_out_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'myproject_axi_master_myproject_axi_master.stream_out0_layer5_out_U' read by process 'myproject_axi_master_myproject_axi_master.store_result_float_array_ap_fixed_16_6_5_3_0_5u_U0'");
                                $fdisplay(fp, "Dependence_Channel_path myproject_axi_master_myproject_axi_master.stream_out0_layer5_out_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    0: begin
                        if (~store_result_float_array_ap_fixed_16_6_5_3_0_5u_U0.out_r_blk_n) begin
                            if (~gmem_out0_ptr_layer5_out_c_U.if_empty_n) begin
                                ...
                                $display("//      Blocked by full output FIFO 'myproject_axi_master_myproject_axi_master.gmem_out0_ptr_layer5_out_c_U' read by process 'myproject_axi_master_myproject_axi_master.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path myproject_axi_master_myproject_axi_master.gmem_out0_ptr_layer5_out_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    2: begin
                        ...
                        if (~store_result_float_array_ap_fixed_16_6_5_3_0_5u_U0.grp_store_result_float_array_ap_fixed_5u_Pipeline_VITIS_LOOP_29_1_fu_71.stream_out0_layer5_out_blk_n) begin
                            if (~stream_out0_layer5_out_U.if_empty_n) begin
                                ...
                                $display("//      Blocked by full output FIFO 'myproject_axi_master_myproject_axi_master.stream_out0_layer5_out_U' read by process 'myproject_axi_master_myproject_axi_master.compute_U0'");
                                $fdisplay(fp, "Dependence_Channel_path myproject_axi_master_myproject_axi_master.stream_out0_layer5_out_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
