...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out0_layer5_out_dout { I 80 vector } stream_out0_layer5_out_empty_n { I 1 bit } stream_out0_layer5_out_read { O 1 bit } stream_out0_layer5_out_num_data_valid { I 8 vector } stream_out0_layer5_out_fifo_cap { I 8 vector } } \
} "
}
