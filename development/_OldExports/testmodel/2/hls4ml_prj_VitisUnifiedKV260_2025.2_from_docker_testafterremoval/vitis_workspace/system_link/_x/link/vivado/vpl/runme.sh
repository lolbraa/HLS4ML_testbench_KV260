...
HD_PWD='/work/development/_OldExports/testmodel/2/hls4ml_prj_VitisUnifiedKV260_2025.2_from_docker_testafterremoval/vitis_workspace/system_link/_x/link/vivado/vpl'
cd "$HD_PWD"
