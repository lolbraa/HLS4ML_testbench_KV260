<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" name="hgq2_1_hls4ml_prj_Vitis_latency_reusefactor4_prj" top="hgq2_1_hls4ml_prj_Vitis_latency_reusefactor4" ideType="classic">
    <files>
        ...
        <file name="../../hgq2_1_hls4ml_prj_Vitis_latency_reusefactor4_test.cpp" sc="0" tb="1" cflags="-std=c++0x -Wno-unknown-pragmas" csimflags="" blackbox="false"/>
        <file name="firmware/hgq2_1_hls4ml_prj_Vitis_latency_reusefactor4.cpp" sc="0" tb="false" cflags="-std=c++0x" csimflags="" blackbox="false"/>
    </files>
    <solutions>
