...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_axi_master_ctlz_19_19_1_1 BINDTYPE {op} TYPE {ctlz} IMPL {auto}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out0_layer12_out_dout { I 320 vector } stream_out0_layer12_out_empty_n { I 1 bit } stream_out0_layer12_out_read { O 1 bit } stream_out0_layer12_out_num_data_valid { I 8 vector } stream_out0_layer12_out_fifo_cap { I 8 vector } } \
} "
}
