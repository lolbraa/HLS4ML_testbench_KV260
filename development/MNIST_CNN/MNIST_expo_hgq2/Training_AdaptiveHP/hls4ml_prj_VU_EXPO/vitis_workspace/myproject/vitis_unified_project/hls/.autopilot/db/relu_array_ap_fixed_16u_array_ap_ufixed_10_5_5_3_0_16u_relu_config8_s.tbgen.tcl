set moduleName relu_array_ap_fixed_16u_array_ap_ufixed_10_5_5_3_0_16u_relu_config8_s
set isTopModule 0
...
set cdfgNum 25
set C_modelName {relu<array<ap_fixed,16u>,array<ap_ufixed<10,5,5,3,0>,16u>,relu_config8>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer7_out int 176 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 176, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer7_out_dout sc_in sc_lv 176 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer7_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":176, "type": "signal", "bundle":{"name": "layer7_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_data_out 0 176 }  { layer7_out_empty_n fifo_status_empty 0 1 }  { layer7_out_read fifo_data_in 1 1 }  { layer7_out_num_data_valid fifo_update 0 8 }  { layer7_out_fifo_cap fifo_data 0 8 } } }
	layer8_out { ap_fifo {  { layer8_out_din fifo_data_out 1 160 }  { layer8_out_full_n fifo_status_empty 0 1 }  { layer8_out_write fifo_data_in 1 1 }  { layer8_out_num_data_valid fifo_update 0 32 }  { layer8_out_fifo_cap fifo_data 0 32 } } }
}
