                    ...
                    fork
                        ...
                        begin
                            ...
                            for(int i=0; i<5; i++) begin
                                logic[63:0] data64bit_gmem_in0_ptr_input_image[$];
                                logic[32-1:0] databusbit_gmem_in0_ptr_input_image[$];
                                ...
                                data64bit_gmem_in0_ptr_input_image.delete(); databusbit_gmem_in0_ptr_input_image.delete();
                                axi_master_wr_control_seq.StableAxiliteNoUpdate=0;
                                for(int j=0; j < (64+32-1)/32; j++) begin
                                    data64bit_gmem_in0_ptr_input_image.push_back( ((refm.mem_blk_pages_gmem_in0.maxi_bundlevar_offset["gmem_in0_ptr_input_image"]+refm.mem_blk_pages_gmem_in0.page_ofst[refm.mem_blk_pages_gmem_in0.rd_page_idx])>>(j*32)) & (2**32-1) );
                                end
                                foreach(data64bit_gmem_in0_ptr_input_image[s]) databusbit_gmem_in0_ptr_input_image[s]=data64bit_gmem_in0_ptr_input_image[s][32-1:0];
                                axi_master_wr_control_seq.StableAxiliteNoUpdate=1;
                                axi_master_wr_control_seq.datamerge_inavg(databusbit_gmem_in0_ptr_input_image, 0, 16, 1);
