...
set C_modelArgList {
	...
	{ stream_out0_layer13_out int 320 regular {fifo 1 volatile } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "batch_size", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "stream_out0_layer13_out", "interface" : "fifo", "bitwidth" : 320, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ stream_in0_input_layer_dout sc_in sc_lv 8 signal 2 } 
	...
	{ stream_out0_layer13_out_din sc_out sc_lv 320 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_out0_layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":320, "type": "signal", "bundle":{"name": "stream_out0_layer13_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	stream_in0_input_layer { ap_fifo {  { stream_in0_input_layer_dout fifo_data_out 0 8 }  { stream_in0_input_layer_empty_n fifo_status_empty 0 1 }  { stream_in0_input_layer_read fifo_data_in 1 1 }  { stream_in0_input_layer_num_data_valid fifo_update 0 8 }  { stream_in0_input_layer_fifo_cap fifo_data 0 8 } } }
	stream_out0_layer13_out { ap_fifo {  { stream_out0_layer13_out_din fifo_data_out 1 320 }  { stream_out0_layer13_out_full_n fifo_status_empty 0 1 }  { stream_out0_layer13_out_write fifo_data_in 1 1 }  { stream_out0_layer13_out_num_data_valid fifo_update 0 8 }  { stream_out0_layer13_out_fifo_cap fifo_data 0 8 } } }
}
