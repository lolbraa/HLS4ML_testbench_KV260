...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_in0_input_layer_din { O 8 vector } stream_in0_input_layer_full_n { I 1 bit } stream_in0_input_layer_write { O 1 bit } stream_in0_input_layer_num_data_valid { I 8 vector } stream_in0_input_layer_fifo_cap { I 8 vector } } \
} "
}
