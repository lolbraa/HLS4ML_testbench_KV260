...
#define AUTOTB_TVOUT_layer11_out "../tv/cdatafile/c.myproject.autotvout_layer11_out.dat"
#define WRAPC_STREAM_SIZE_OUT_layer11_out "../tv/stream_size/stream_size_out_layer11_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_layer11_out "../tv/stream_size/stream_egress_status_layer11_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_layer11_out "../tv/rtldatafile/rtl.myproject.autotvout_layer11_out.dat"
...
extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_input_layer, void* __xlx_apatb_param_layer11_out)
{
  ...
  static hls::sim::Stream<hls::sim::Byte<20>> port1 {
    ...
    .name = "layer11_out",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer11_out),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_layer11_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_layer11_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_layer11_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<20>>*)__xlx_apatb_param_layer11_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_input_layer, __xlx_apatb_param_layer11_out);
    port1.buffer();
