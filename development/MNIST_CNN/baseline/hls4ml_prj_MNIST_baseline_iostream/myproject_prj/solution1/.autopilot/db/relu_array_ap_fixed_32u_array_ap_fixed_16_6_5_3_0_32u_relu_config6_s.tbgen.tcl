set moduleName relu_array_ap_fixed_32u_array_ap_fixed_16_6_5_3_0_32u_relu_config6_s
set isTopModule 0
...
set cdfgNum 21
set C_modelName {relu<array<ap_fixed,32u>,array<ap_fixed<16,6,5,3,0>,32u>,relu_config6>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer5_out int 1344 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 1344, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer5_out_dout sc_in sc_lv 1344 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer5_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1344, "type": "signal", "bundle":{"name": "layer5_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer5_out { ap_fifo {  { layer5_out_dout fifo_data_out 0 1344 }  { layer5_out_empty_n fifo_status_empty 0 1 }  { layer5_out_read fifo_data_in 1 1 }  { layer5_out_num_data_valid fifo_update 0 8 }  { layer5_out_fifo_cap fifo_data 0 8 } } }
	layer6_out { ap_fifo {  { layer6_out_din fifo_data_out 1 512 }  { layer6_out_full_n fifo_status_empty 0 1 }  { layer6_out_write fifo_data_in 1 1 }  { layer6_out_num_data_valid fifo_update 0 32 }  { layer6_out_fifo_cap fifo_data 0 32 } } }
}
