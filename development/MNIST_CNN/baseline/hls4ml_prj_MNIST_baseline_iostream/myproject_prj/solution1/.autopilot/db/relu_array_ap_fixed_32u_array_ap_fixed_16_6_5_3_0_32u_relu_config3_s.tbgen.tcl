...
set C_modelArgList {
	{ layer2_out int 1184 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 1184, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer2_out_dout sc_in sc_lv 1184 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer2_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1184, "type": "signal", "bundle":{"name": "layer2_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_data_out 0 1184 }  { layer2_out_empty_n fifo_status_empty 0 1 }  { layer2_out_read fifo_data_in 1 1 }  { layer2_out_num_data_valid fifo_update 0 11 }  { layer2_out_fifo_cap fifo_data 0 11 } } }
	layer3_out { ap_fifo {  { layer3_out_din fifo_data_out 1 512 }  { layer3_out_full_n fifo_status_empty 0 1 }  { layer3_out_write fifo_data_in 1 1 }  { layer3_out_num_data_valid fifo_update 0 32 }  { layer3_out_fifo_cap fifo_data 0 32 } } }
}
