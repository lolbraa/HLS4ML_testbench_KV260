set moduleName pooling2d_cl_array_array_ap_ufixed_4_2_0_3_0_16u_config9_s
set isTopModule 0
...
set cdfgNum 25
set C_modelName {pooling2d_cl<array,array<ap_ufixed<4,2,0,3,0>,16u>,config9>}
...
set Spec2ImplPortList { 
	layer8_out { ap_fifo {  { layer8_out_dout fifo_data_out 0 144 }  { layer8_out_empty_n fifo_status_empty 0 1 }  { layer8_out_read fifo_data_in 1 1 }  { layer8_out_num_data_valid fifo_update 0 8 }  { layer8_out_fifo_cap fifo_data 0 8 } } }
	layer9_out { ap_fifo {  { layer9_out_din fifo_data_out 1 64 }  { layer9_out_full_n fifo_status_empty 0 1 }  { layer9_out_write fifo_data_in 1 1 }  { layer9_out_num_data_valid fifo_update 0 6 }  { layer9_out_fifo_cap fifo_data 0 6 } } }
}
