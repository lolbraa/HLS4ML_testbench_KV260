...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out0_layer13_out_din { O 320 vector } stream_out0_layer13_out_full_n { I 1 bit } stream_out0_layer13_out_write { O 1 bit } stream_out0_layer13_out_num_data_valid { I 8 vector } stream_out0_layer13_out_fifo_cap { I 8 vector } } \
} "
}
