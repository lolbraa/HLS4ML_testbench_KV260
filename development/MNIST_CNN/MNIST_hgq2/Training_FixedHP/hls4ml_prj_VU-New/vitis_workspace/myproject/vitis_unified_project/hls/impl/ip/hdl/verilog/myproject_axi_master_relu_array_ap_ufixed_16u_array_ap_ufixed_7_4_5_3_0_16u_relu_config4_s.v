...
module myproject_axi_master_relu_array_ap_ufixed_16u_array_ap_ufixed_7_4_5_3_0_16u_relu_config4_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_103)) begin
        if ((icmp_ln41_fu_62_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln41_fu_62_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((layer4_out_full_n == 1'b0) | (layer3_out_empty_n == 1'b0));
end
...
assign i_2_fu_68_p2 = (ap_sig_allocacmp_i_1 + 10'd1);

assign icmp_ln41_fu_62_p2 = ((ap_sig_allocacmp_i_1 == 10'd676) ? 1'b1 : 1'b0);

assign layer4_out_din = layer3_out_dout;

assign start_out = real_start;

endmodule //myproject_axi_master_relu_array_ap_ufixed_16u_array_ap_ufixed_7_4_5_3_0_16u_relu_config4_s
