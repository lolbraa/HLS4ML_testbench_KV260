...
if {[file isfile myproject_axi_stream.autotvin.dat]} {
	file delete -force myproject_axi_stream.autotvin.dat
}

if {[file isfile myproject_axi_stream.autotvout.dat]} {
	file delete -force myproject_axi_stream.autotvout.dat
}
