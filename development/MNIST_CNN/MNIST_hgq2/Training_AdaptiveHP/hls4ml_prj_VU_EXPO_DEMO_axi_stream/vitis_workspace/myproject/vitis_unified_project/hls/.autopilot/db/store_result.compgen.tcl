...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { axi_output_stream_TVALID { O 1 bit } axi_output_stream_TREADY { I 1 bit } axi_output_stream_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { model_output_stream_dout { I 160 vector } model_output_stream_empty_n { I 1 bit } model_output_stream_read { O 1 bit } model_output_stream_num_data_valid { I 2 vector } model_output_stream_fifo_cap { I 2 vector } } \
} "
}
