...
entity myproject_axi_stream_fifo_w32_d2_S is 
    generic (
...
architecture rtl of myproject_axi_stream_fifo_w32_d2_S is
...
------------------------Component----------------------
    component myproject_axi_stream_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_myproject_axi_stream_fifo_w32_d2_S_ShiftReg : myproject_axi_stream_fifo_w32_d2_S_ShiftReg
    generic map (
...
entity myproject_axi_stream_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end myproject_axi_stream_fifo_w32_d2_S_ShiftReg;

architecture rtl of myproject_axi_stream_fifo_w32_d2_S_ShiftReg is
