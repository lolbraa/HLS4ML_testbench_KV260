...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "myproject_axi_stream.autotvin.dat"
	set constFileTvOut       "myproject_axi_stream.autotvout.dat"
	set constFileHdlTvIn     "myproject_axi_stream.autohdltvin.dat"
	set constFileHdlTvOut    "myproject_axi_stream.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
