...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_axi_stream_sparsemux_9_3_4_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { axi_input_stream_TVALID { I 1 bit } axi_input_stream_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { axi_input_stream_TREADY { O 1 bit } axi_input_stream_TLAST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { model_input_stream_din { O 8 vector } model_input_stream_full_n { I 1 bit } model_input_stream_write { O 1 bit } model_input_stream_num_data_valid { I 11 vector } model_input_stream_fifo_cap { I 11 vector } } \
} "
}
