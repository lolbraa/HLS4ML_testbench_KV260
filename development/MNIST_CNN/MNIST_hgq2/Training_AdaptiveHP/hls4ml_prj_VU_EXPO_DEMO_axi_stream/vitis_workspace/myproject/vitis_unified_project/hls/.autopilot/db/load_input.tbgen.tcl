...
set portList { 
	...
	{ model_input_stream_din sc_out sc_lv 8 signal 6 } 
	{ model_input_stream_full_n sc_in sc_logic 1 signal 6 } 
	{ model_input_stream_write sc_out sc_logic 1 signal 6 } 
	{ model_input_stream_num_data_valid sc_in sc_lv 11 signal 6 } 
	{ model_input_stream_fifo_cap sc_in sc_lv 11 signal 6 } 
}
set NewPortList {[ 
