...
`define TV_IN_OFFSET_gmem_in0_ptr_input_layer "../tv/cdatafile/c.myproject_axi_master.autotvin_gmem_in0_ptr_input_layer.dat"
...
`define TV_IN_OFFSET_gmem_out0_ptr_layer13_out "../tv/cdatafile/c.myproject_axi_master.autotvin_gmem_out0_ptr_layer13_out.dat"
`define TV_IN_gmem_in0_ptr_input_layer "../tv/cdatafile/c.myproject_axi_master.autotvin_gmem_in0_ptr_input_layer.dat"
`define TV_OUT_gmem_in0_ptr_input_layer ""
`define TV_IN_gmem_out0_ptr_layer13_out "../tv/cdatafile/c.myproject_axi_master.autotvin_gmem_out0_ptr_layer13_out.dat"
`define TV_OUT_gmem_out0_ptr_layer13_out ""
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_gmem_in0.whole_page_size=3200;
        mem_blk_pages_gmem_in0.maxi_bundlevar_fpath["gmem_in0_ptr_input_layer"]=`TV_IN_OFFSET_gmem_in0_ptr_input_layer;
        mem_blk_pages_gmem_in0.set_binary(1);
        mem_blk_pages_gmem_in0.tvinload_pagechk_atinit(fpath, 784*((32+7)/8), 0, 0);
        fpath.delete();
        ...
        mem_blk_pages_gmem_out0.whole_page_size=104;
        mem_blk_pages_gmem_out0.maxi_bundlevar_fpath["gmem_out0_ptr_layer13_out"]=`TV_IN_OFFSET_gmem_out0_ptr_layer13_out;
        mem_blk_pages_gmem_out0.set_binary(1);
        mem_blk_pages_gmem_out0.tvinload_pagechk_atinit(fpath, 10*((32+7)/8), 0, 0);
