...
//
//==============================================================
`ifndef MYPROJECT_AXI_MASTER_SCOREBOARD__SV                                                       
    `define MYPROJECT_AXI_MASTER_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class myproject_axi_master_scoreboard extends uvm_component;                                        
                                                                                               
        myproject_axi_master_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(myproject_axi_master_scoreboard)                                     
            ...
            fork                                                                               
                ...
                forever begin
                    ...
                    `uvm_info(this.get_full_name(), "receive dut2tb_ap_done and do axim dump", UVM_LOW)
                            refm.mem_blk_pages_gmem_in0.tvout_dump_frontpage(0);
                            refm.mem_blk_pages_gmem_out0.tvout_dump_frontpage(1);
                end                                                                            
                begin                                                                          
                    @refm.finish;                                                              
