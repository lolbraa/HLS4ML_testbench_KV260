...
entity myproject_axi_master_relu_array_ap_ufixed_16u_array_ap_ufixed_5_5_5_3_0_16u_relu_config4_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of myproject_axi_master_relu_array_ap_ufixed_16u_array_ap_ufixed_5_5_5_3_0_16u_relu_config4_s is 
...
attribute shreg_extract : string;
    ...
    signal i_2_fu_68_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_103)) then
                if ((icmp_ln41_fu_62_p2 = ap_const_lv1_0)) then 
    ...
    ap_block_state2_pp0_stage0_iter1_grp1_assign_proc : process(layer3_out_empty_n, layer4_out_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1_grp1 <= ((layer4_out_full_n = ap_const_logic_0) or (layer3_out_empty_n = ap_const_logic_0));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln41_fu_62_p2, ap_start_int)
    begin
        if (((icmp_ln41_fu_62_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_i_1_assign_proc : process(ap_CS_fsm_pp0_stage0, i_fu_36, ap_loop_init, ap_block_pp0_stage0, ap_start_int)
    begin
    ...
    i_2_fu_68_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv10_1));
    icmp_ln41_fu_62_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv10_2A4) else "0";
    ...
    layer4_out_din <= layer3_out_dout;
