...
module AESL_axi_master_gmem_in0 (
    clk,
    reset,
    TRAN_gmem_in0_AWVALID,
    TRAN_gmem_in0_AWREADY,
    TRAN_gmem_in0_AWADDR,
    TRAN_gmem_in0_AWID,
    TRAN_gmem_in0_AWLEN,
    TRAN_gmem_in0_AWSIZE,
    TRAN_gmem_in0_AWBURST,
    TRAN_gmem_in0_AWLOCK,
    TRAN_gmem_in0_AWCACHE,
    TRAN_gmem_in0_AWPROT,
    TRAN_gmem_in0_AWQOS,
    TRAN_gmem_in0_AWREGION,
    TRAN_gmem_in0_AWUSER,
    TRAN_gmem_in0_WVALID,
    TRAN_gmem_in0_WREADY,
    TRAN_gmem_in0_WDATA,
    TRAN_gmem_in0_WSTRB,
    TRAN_gmem_in0_WLAST,
    TRAN_gmem_in0_WID,
    TRAN_gmem_in0_WUSER,
    TRAN_gmem_in0_ARVALID,
    TRAN_gmem_in0_ARREADY,
    TRAN_gmem_in0_ARADDR,
    TRAN_gmem_in0_ARID,
    TRAN_gmem_in0_ARLEN,
    TRAN_gmem_in0_ARSIZE,
    TRAN_gmem_in0_ARBURST,
    TRAN_gmem_in0_ARLOCK,
    TRAN_gmem_in0_ARCACHE,
    TRAN_gmem_in0_ARPROT,
    TRAN_gmem_in0_ARQOS,
    TRAN_gmem_in0_ARREGION,
    TRAN_gmem_in0_ARUSER,
    TRAN_gmem_in0_RVALID,
    TRAN_gmem_in0_RREADY,
    TRAN_gmem_in0_RDATA,
    TRAN_gmem_in0_RLAST,
    TRAN_gmem_in0_RID,
    TRAN_gmem_in0_RUSER,
    TRAN_gmem_in0_RRESP,
    TRAN_gmem_in0_BVALID,
    TRAN_gmem_in0_BREADY,
    TRAN_gmem_in0_BRESP,
    TRAN_gmem_in0_BID,
    TRAN_gmem_in0_BUSER,
    ready,
...
`define TV_OUT_gmem_in0 "../tv/rtldatafile/rtl.myproject_axi_master.autotvout_gmem_in0.dat"
 parameter gmem_in0_ADDR_BITWIDTH = 32'd 64;
 parameter gmem_in0_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem_in0_DATA_BITWIDTH = 32'd 32;
 parameter gmem_in0_WUSER_BITWIDTH = 32'd 1;
 parameter gmem_in0_ID_BITWIDTH = 32'd 1;
 parameter gmem_in0_RUSER_BITWIDTH = 32'd 1;
 parameter gmem_in0_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter gmem_in0_C_DATA_BITWIDTH = 32'd 32;
parameter gmem_in0_transaction_depth = 32'd 16;
parameter gmem_in0_mem_depth = 32'd 16;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_gmem_in0_AWVALID;
output  TRAN_gmem_in0_AWREADY;
input [gmem_in0_ADDR_BITWIDTH - 1 : 0] TRAN_gmem_in0_AWADDR;
input [gmem_in0_ID_BITWIDTH - 1 : 0] TRAN_gmem_in0_AWID;
input [8 - 1 : 0] TRAN_gmem_in0_AWLEN;
input [3 - 1 : 0] TRAN_gmem_in0_AWSIZE;
input [2 - 1 : 0] TRAN_gmem_in0_AWBURST;
input [2 - 1 : 0] TRAN_gmem_in0_AWLOCK;
input [4 - 1 : 0] TRAN_gmem_in0_AWCACHE;
input [3 - 1 : 0] TRAN_gmem_in0_AWPROT;
input [4 - 1 : 0] TRAN_gmem_in0_AWQOS;
input [4 - 1 : 0] TRAN_gmem_in0_AWREGION;
input [gmem_in0_AWUSER_BITWIDTH - 1 : 0] TRAN_gmem_in0_AWUSER;
input  TRAN_gmem_in0_WVALID;
output  TRAN_gmem_in0_WREADY;
input [gmem_in0_DATA_BITWIDTH - 1 : 0] TRAN_gmem_in0_WDATA;
input [gmem_in0_DATA_BITWIDTH/8 - 1 : 0] TRAN_gmem_in0_WSTRB;
input  TRAN_gmem_in0_WLAST;
input  TRAN_gmem_in0_WID;
input [gmem_in0_WUSER_BITWIDTH - 1 : 0] TRAN_gmem_in0_WUSER;
input  TRAN_gmem_in0_ARVALID;
output  TRAN_gmem_in0_ARREADY;
input [gmem_in0_ADDR_BITWIDTH - 1 : 0] TRAN_gmem_in0_ARADDR;
input [gmem_in0_ID_BITWIDTH - 1 : 0] TRAN_gmem_in0_ARID;
input [8 - 1 : 0] TRAN_gmem_in0_ARLEN;
input [3 - 1 : 0] TRAN_gmem_in0_ARSIZE;
input [2 - 1 : 0] TRAN_gmem_in0_ARBURST;
input [2 - 1 : 0] TRAN_gmem_in0_ARLOCK;
input [4 - 1 : 0] TRAN_gmem_in0_ARCACHE;
input [3 - 1 : 0] TRAN_gmem_in0_ARPROT;
input [4 - 1 : 0] TRAN_gmem_in0_ARQOS;
input [4 - 1 : 0] TRAN_gmem_in0_ARREGION;
input  TRAN_gmem_in0_ARUSER;
output  TRAN_gmem_in0_RVALID;
input  TRAN_gmem_in0_RREADY;
output [gmem_in0_DATA_BITWIDTH - 1 : 0] TRAN_gmem_in0_RDATA;
output  TRAN_gmem_in0_RLAST;
output [gmem_in0_ID_BITWIDTH - 1 : 0] TRAN_gmem_in0_RID;
output [gmem_in0_RUSER_BITWIDTH - 1 : 0] TRAN_gmem_in0_RUSER;
output [2 - 1 : 0] TRAN_gmem_in0_RRESP;
output  TRAN_gmem_in0_BVALID;
input  TRAN_gmem_in0_BREADY;
output [2 - 1 : 0] TRAN_gmem_in0_BRESP;
output [gmem_in0_ID_BITWIDTH - 1 : 0] TRAN_gmem_in0_BID;
output [gmem_in0_BUSER_BITWIDTH - 1 : 0] TRAN_gmem_in0_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [gmem_in0_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [gmem_in0_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [gmem_in0_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [gmem_in0_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [gmem_in0_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [gmem_in0_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [gmem_in0_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [gmem_in0_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [gmem_in0_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [gmem_in0_DATA_BITWIDTH - 1 : 0] gmem_in0_mem_0 [0: gmem_in0_mem_depth - 1] = '{default : 'h0}; 
reg [gmem_in0_DATA_BITWIDTH - 1 : 0] gmem_in0_mem_1 [0: gmem_in0_mem_depth - 1] = '{default : 'h0}; 
reg [gmem_in0_DATA_BITWIDTH - 1 : 0] gmem_in0_mem_2 [0: gmem_in0_mem_depth - 1] = '{default : 'h0}; 
reg [gmem_in0_DATA_BITWIDTH - 1 : 0] gmem_in0_mem_3 [0: gmem_in0_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [gmem_in0_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [gmem_in0_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [gmem_in0_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_gmem_in0_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_gmem_in0_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_gmem_in0_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_gmem_in0_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_gmem_in0_BRESP = BRESP_tmp;
assign TRAN_gmem_in0_BID = BID_tmp;
assign TRAN_gmem_in0_RDATA = RDATA_tmp;
assign TRAN_gmem_in0_RRESP = RRESP_tmp;
assign TRAN_gmem_in0_RLAST = RLAST_tmp;
assign TRAN_gmem_in0_RID = RID_tmp;
assign TRAN_gmem_in0_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = gmem_in0_C_DATA_BITWIDTH;
end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem_in0_AWREADY & TRAN_gmem_in0_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_gmem_in0_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_gmem_in0_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_gmem_in0_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_gmem_in0_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_gmem_in0_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem_in0_ARREADY & TRAN_gmem_in0_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_gmem_in0_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_gmem_in0_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_gmem_in0_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_gmem_in0_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_gmem_in0_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem_in0_WREADY & TRAN_gmem_in0_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_gmem_in0_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_gmem_in0_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_gmem_in0_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem_in0_AWVALID && TRAN_gmem_in0_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem_in0_ARVALID && TRAN_gmem_in0_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem_in0_WVALID && TRAN_gmem_in0_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem_in0_WVALID && TRAN_gmem_in0_WREADY && TRAN_gmem_in0_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_gmem_in0_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_gmem_in0_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [gmem_in0_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [gmem_in0_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [gmem_in0_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_in0_mem_depth) begin
                $display ("/workspace/HLS4ML_testbench_KV260/development/testmodel/2/hls4ml_prj_VitisUnifiedKV260_2023.2/vitis_workspace/myproject/vitis_unified_project/hls/sim/verilog/AESL_axi_master_gmem_in0.v: Write request address %d exceed AXI master gmem_in0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_in0_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = gmem_in0_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = gmem_in0_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = gmem_in0_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = gmem_in0_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : gmem_in0_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : gmem_in0_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : gmem_in0_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : gmem_in0_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = gmem_in0_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = gmem_in0_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = gmem_in0_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = gmem_in0_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : gmem_in0_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : gmem_in0_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : gmem_in0_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : gmem_in0_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_in0_mem_depth) begin
                $display ("/workspace/HLS4ML_testbench_KV260/development/testmodel/2/hls4ml_prj_VitisUnifiedKV260_2023.2/vitis_workspace/myproject/vitis_unified_project/hls/sim/verilog/AESL_axi_master_gmem_in0.v: Read request address %d exceed AXI master gmem_in0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_in0_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= gmem_in0_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= gmem_in0_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= gmem_in0_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= gmem_in0_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_gmem_in0_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= gmem_in0_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= gmem_in0_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= gmem_in0_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= gmem_in0_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  reg [gmem_in0_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  fp = $fopen(`TV_IN_gmem_in0,"rb"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_gmem_in0); 
      $finish; 
  end 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      mem_tmp[gmem_in0_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < gmem_in0_transaction_depth; i = i + 1) begin 
          ...
          if (i%1 == 0) begin
              case(mem_page)
                  0 : gmem_in0_mem_0[i/1] = mem_tmp;
                  1 : gmem_in0_mem_1[i/1] = mem_tmp;
                  2 : gmem_in0_mem_2[i/1] = mem_tmp;
                  3 : gmem_in0_mem_3[i/1] = mem_tmp;
