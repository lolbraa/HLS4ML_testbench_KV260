...
set C_modelArgList {
	...
	{ gmem_out0_ptr_layer9_out int 64 regular {axi_slave 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "gmem_in0_ptr_linput","offset": { "type": "dynamic","port_name": "gmem_in0_ptr_linput","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem_out0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "gmem_out0_ptr_layer9_out","offset": { "type": "dynamic","port_name": "gmem_out0_ptr_layer9_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "gmem_out0_ptr_layer9_out", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
...
set ArgLastReadFirstWriteLatency {
	myproject_axi_master {
		...
		stream_out0_layer9_out {Type IO LastRead -1 FirstWrite -1}}
	entry_proc {
		gmem_out0_ptr_layer9_out {Type I LastRead 0 FirstWrite -1}
