; ModuleID = '/home/ncgadmin/Bachelor/HLS4ML_testbench_KV260/development/hgq2_fixed/1/hls4ml_prj_fix_test_hgq2/vitis_workspace/myproject/vitis_unified_project/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline willreturn
define void @apatb_myproject_axi_master_ir(float* noalias nocapture nonnull readonly "maxi" %gmem_in0_ptr_input_layer_1, float* noalias nocapture nonnull "maxi" %gmem_out0_ptr_layer12_out, i32 %batch_size) local_unnamed_addr #0 {
entry:
  %0 = bitcast float* %gmem_in0_ptr_input_layer_1 to [16 x float]*
  %gmem_in0_ptr_input_layer_1_copy = alloca [16 x float], align 512
  %1 = bitcast float* %gmem_out0_ptr_layer12_out to [5 x float]*
  %gmem_out0_ptr_layer12_out_copy = alloca [5 x float], align 512
  call fastcc void @copy_in([16 x float]* nonnull %0, [16 x float]* nonnull align 512 %gmem_in0_ptr_input_layer_1_copy, [5 x float]* nonnull %1, [5 x float]* nonnull align 512 %gmem_out0_ptr_layer12_out_copy)
  call void @apatb_myproject_axi_master_hw([16 x float]* %gmem_in0_ptr_input_layer_1_copy, [5 x float]* %gmem_out0_ptr_layer12_out_copy, i32 %batch_size)
  call void @copy_back([16 x float]* %0, [16 x float]* %gmem_in0_ptr_input_layer_1_copy, [5 x float]* %1, [5 x float]* %gmem_out0_ptr_layer12_out_copy)
  ret void
}
