...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_22 -L smartconnect_v1_0 -L zynq_ultra_ps_e_vip_v1_0_22 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L xpm -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_37 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_22 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_vip_v1_1_22 -L zynq_ultra_ps_e_vip_v1_0_22 -L xlconcat_v2_1_7 -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_14 -L axi_data_fifo_v2_1_36 -L axi_crossbar_v2_1_38 -L axi_protocol_converter_v2_1_37 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot vitis_design_wrapper xil_defaultlib.vitis_design_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vitis_design_wrapper -key {Behavioral:sim_1:Functional:vitis_design_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_8c12.protoinst" -protoinst "protoinst_files/vitis_design.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/usr/lib/AMD/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vitis_design_wrapper.wdb xsim.dir libdpi.so)
